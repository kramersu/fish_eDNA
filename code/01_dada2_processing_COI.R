...
setwd("C:/Users/KRAMERS/Documents/Gerald_fish_eDNA/raw/COI/")
#renomae files
...
path_raw<-c("C:/Users/KRAMERS/Documents/Gerald_fish_eDNA/raw/COI/")
path<-c("C:/Users/KRAMERS/Documents/Gerald_fish_eDNA/COI/")
...
table(nchar(getSequences(seqtab)))#no clear pattern of sequence length distribution, remove products under 100bp
...
sum(seqtab2.nochim)/sum(seqtab2)#91% of reads remain
...
ps_sub %>%
  refseq() %>%
  Biostrings::writeXStringSet("C:/Users/KRAMERS/Documents/Gerald_fish_eDNA/COI/ASV.fna",append=FALSE,
